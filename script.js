...
const translations = {
    vi: {
        ...
        "about.p1": "Tôi tốt nghiệp Quản trị nguồn nhân lực (Trường Đại học Kinh tế – Đại học Đà Nẵng) và vào nghề tuyển dụng từ khi còn là sinh viên. Hơn 3 năm qua, tôi đi từ thực tập sinh lên HR Generalist phụ trách trọn vòng đời nhân sự tại FPT Telecom, Fish Golden, COF Incorporate và COWI Group — phần lớn là startup, nơi tôi xây hệ thống HR từ những viên gạch đầu tiên.",
        "about.p2": "Với tôi, nghề HR gói gọn trong ba việc: chọn đúng người, xây đúng chính sách và giữ được nhân tài. AI (ChatGPT, Claude, Gemini) có mặt trong hầu hết đầu việc hằng ngày của tôi — từ viết JD đến báo cáo.",
        ...
        "exp.c1desc": "Tuyển thành công 50+ vị trí từ nhân viên đến cấp trưởng phòng — Sales, Marketing, Livestream, CSKH, BO... Lead dự án headhunt Cowi Works.",
        "exp.c2title": "Hiệu suất & Vận hành",
        "exp.c2desc": "Giám sát hiệu suất theo tuần; chấm công – hỗ trợ tính lương; tham gia xây dựng chính sách và quản lý hồ sơ lao động.",
        "exp.c3title": "Văn hóa & Sự kiện",
        "exp.c3desc": "Xây dựng văn hóa và onboarding; tổ chức sinh nhật, teambuilding — kiêm luôn vai trò MC hoạt náo.",
        "exp.c4title": "AI trong HR",
        "exp.c4desc": "Dùng ChatGPT, Claude, Gemini cho JD, sàng lọc hồ sơ, content và báo cáo — tiết kiệm đáng kể thời gian xử lý.",

        "jn.chip": "Học vấn & Kinh nghiệm", "jn.title": "Hành trình",
        "jn.cdfRole": "Cuộc thi Giám sát Kinh doanh Tài năng",
        "jn.cdfSum": "Vượt qua vòng tuyển chọn cuộc thi CDF — tham gia để trải nghiệm quy trình đánh giá ứng viên của tập đoàn đa quốc gia từ góc nhìn người dự tuyển.",
        "jn.cdfTag": "Đậu vòng tuyển chọn",
        "jn.j1sum": "Phụ trách toàn diện mảng nhân sự, làm việc trực tiếp với CEO.",
        "jn.j1b1": "Tuyển dụng Digital Marketing, BO; xây database ứng viên và đo hiệu quả từng kênh sourcing.",
        "jn.j1b2": "Lead dự án Cowi Works — headhunt & cung ứng nhân sự Marketing, trực tiếp thương lượng với khách hàng.",
        "jn.j1b3": "Giám sát hiệu suất tuần; hỗ trợ chấm công – tính lương; tham gia xây dựng chính sách, quy chế.",
        "jn.j2sum": "Kiêm cả tuyển dụng lẫn hành chính – nhân sự cho công ty thương mại điện tử.",
        "jn.j2b1": "Tuyển khối BO, Livestream, Affiliate qua Facebook, Zalo, LinkedIn, Threads, TikTok.",
        "jn.j2b2": "Xây quy trình onboarding; tổ chức sinh nhật, teambuilding; tự thiết kế poster tuyển dụng bằng Canva.",
        "jn.j2b3": "Chấm công – tính lương, chính sách thưởng, quản lý tài sản văn phòng.",
        "jn.j3sum": "Tuyển dụng khối lượng lớn cho ngành Cosmetic – FMCG.",
        "jn.j3b1": "Tuyển BO, Mass, Sales qua Facebook, LinkedIn, Zalo; báo cáo tuyển dụng theo tuần.",
        "jn.j3b2": "Sàng lọc – sơ vấn điện thoại, phỏng vấn, đánh giá thử việc.",
        "jn.j3b3": "Tổ chức sinh nhật, teambuilding cho CBNV.",
        "jn.j4role": "Thực tập sinh Hành chính – Nhân sự",
        "jn.j4sum": "Bước đệm thực chiến đầu tiên trong môi trường doanh nghiệp lớn.",
        "jn.j4b1": "Đăng tin, sàng lọc hồ sơ, sơ vấn và chăm sóc ứng viên phỏng vấn.",
        "jn.j4b2": "Theo dõi tình hình tuyển dụng, báo cáo theo tháng.",
        "jn.j5sum": "Dẫn dắt nhóm tuyển dụng IT từ xa khi còn là sinh viên năm cuối.",
        "jn.j5b1": "Lead tuyển dụng vị trí CNTT: lập kế hoạch, tìm nguồn, báo cáo tháng.",
        "jn.j5b2": "Xây quy trình – chính sách; đào tạo nhân viên mới.",
        "jn.eduSchool": "Trường Đại học Kinh tế – Đại học Đà Nẵng",
        "jn.eduMajor": "Cử nhân Quản trị nguồn nhân lực",
        "jn.eduSum": "Ban chấp hành đoàn khoa Quản trị Kinh doanh; leader BTC các hoạt động thiện nguyện, ngoại khóa.",
    ...
    en: {
        ...
        "about.p1": "I graduated in Human Resource Management (University of Economics – University of Danang) and started recruiting while still a student. Over 3+ years I grew from intern to HR Generalist owning the full employee lifecycle at FPT Telecom, Fish Golden, COF Incorporate and COWI Group — mostly startups, where I built the HR function from the ground up.",
        "about.p2": "To me, HR comes down to three things: selecting the right people, building the right policies, and retaining talent. AI (ChatGPT, Claude, Gemini) sits inside most of my daily work — from JDs to reports.",
        ...
        "exp.c1desc": "50+ successful hires from staff to manager level — Sales, Marketing, Livestream, Customer Service, BO... Led the Cowi Works headhunt project.",
        "exp.c2title": "Performance & Operations",
        "exp.c2desc": "Weekly performance monitoring; timekeeping and payroll support; contributing to policies and labor records.",
        "exp.c3title": "Culture & Events",
        "exp.c3desc": "Built culture and onboarding; organized birthdays and team building — often as the event MC myself.",
        "exp.c4title": "AI in HR",
        "exp.c4desc": "ChatGPT, Claude and Gemini for JDs, resume screening, content and reports — cutting processing time significantly.",

        "jn.chip": "Education & Experience", "jn.title": "Journey",
        "jn.cdfRole": "Talented Sales Supervisor competition",
        "jn.cdfSum": "Passed the selection round of Unilever's CDF competition — joined to experience a multinational's candidate assessment process from the applicant's seat.",
        "jn.cdfTag": "Passed selection",
        "jn.j1sum": "Owning the entire HR function, working directly with the CEO.",
        "jn.j1b1": "Recruited Digital Marketing and BO roles; built a candidate database and measured each sourcing channel.",
        "jn.j1b2": "Led Cowi Works — a Marketing headhunt & staffing project, negotiating directly with clients.",
        "jn.j1b3": "Weekly performance monitoring; timekeeping and payroll support; contributed to company policies.",
        "jn.j2sum": "Covered both recruitment and HR administration for an e-commerce company.",
        "jn.j2b1": "Recruited BO, Livestream and Affiliate roles via Facebook, Zalo, LinkedIn, Threads and TikTok.",
        "jn.j2b2": "Built onboarding; organized birthdays and team building; designed recruitment posters with Canva.",
        "jn.j2b3": "Timekeeping and payroll, reward policies, office asset management.",
        "jn.j3sum": "High-volume recruitment for the Cosmetics – FMCG industry.",
        "jn.j3b1": "Recruited BO, Mass and Sales roles via Facebook, LinkedIn and Zalo; weekly recruitment reports.",
        "jn.j3b2": "Resume screening, phone screening, interviews and probation assessment.",
        "jn.j3b3": "Organized birthdays and team building for staff.",
        "jn.j4role": "HR Administration Intern",
        "jn.j4sum": "First hands-on experience in a large corporate environment.",
        "jn.j4b1": "Job postings, resume screening, phone screening and candidate care for interviews.",
        "jn.j4b2": "Maintained recruitment trackers and monthly reports.",
        "jn.j5sum": "Led a remote IT recruitment team while still a final-year student.",
        "jn.j5b1": "Led IT recruitment: planning, sourcing and monthly reporting.",
        ...
        "jn.eduSum": "Executive board of the Business Administration Faculty Youth Union; led organizing committees for charity and extracurricular activities.",
